                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    >
                                        ...
                                        <option 
                                            ...
                                            :key="customer.id" 
                                            :value="customer.id"
                                            :selected="customer.id === loan.customer_id"
                                        >
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        placeholder="0.00"
                                    >
                                    <p v-if="form.errors.interest_rate" class="mt-1 text-sm text-red-600">
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        max="360"
                                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                        :class="{ 'border-red-300': form.errors.term_months }"
                                        placeholder="12"
                                    >
                                    <p v-if="form.errors.term_months" class="mt-1 text-sm text-red-600">
                                ...
                                <div>
                                    ...
                                    <select 
                                        ...
                                        required
                                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                        :class="{ 'border-red-300': form.errors.purpose }"
                                    >
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea 
                                        ...
                                        rows="3"
                                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                        :class="{ 'border-red-300': form.errors.purpose_description }"
                                        placeholder="Describe the purpose of this loan in detail..."
                                    ></textarea>
                                    <p v-if="form.errors.purpose_description" class="mt-1 text-sm text-red-600">
                                ...
                                <div class="md:col-span-2 bg-blue-50 p-4 rounded-lg">
                                    <h3 class="text-lg font-medium text-gray-900 mb-3">Current Loan Information</h3>
                                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                        <div>
                                        ...
                                        <div>
                                            <p class="text-gray-600">Current Rate</p>
                                            <p class="font-semibold text-gray-900">{{ loan.interest_rate }}%</p>
                                        </div>
                                        <div>
                                            <p class="text-gray-600">Current Term</p>
                                            <p class="font-semibold text-gray-900">{{ loan.term_months }} months</p>
                                        </div>
                                        <div>
